...
func SeedDaily(db *gorm.DB) {
	dailyData := []models.DailyChallenge{
		//1
		{
			...
			Photo:       "https://firebasestorage.googleapis.com/v0/b/metabolic-b97d2.appspot.com/o/image%2FchallengeDefault.svg?alt=media&token=5c5e8a1f-e4d7-4fe1-8806-d7dbf1683a0d",
