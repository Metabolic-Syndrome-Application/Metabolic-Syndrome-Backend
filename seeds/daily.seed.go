...
func SeedDaily(db *gorm.DB) {
	dailyData := []models.DailyChallenge{
		//1
		{
			...
			Photo:       "https://firebasestorage.googleapis.com/v0/b/metabolic-b97d2.appspot.com/o/image%2FchallengeDefault.svg?alt=media&token=164860df-2927-4ceb-ade9-5758a9811aab",
